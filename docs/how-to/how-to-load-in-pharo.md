# How to load Willow Auth0 in a Pharo image
...
4. Evaluate:
    ...
    Metacello new
      ...
      repository: 'github://ba-st/Willow-Auth0:release-candidate';
      load: 'Development'.
    ```
...
5. Select *Clone from github.com* and enter `ba-st` as owner name and `Willow-Auth0`
   as project name
6. Click *Ok*
7. Select the repository in the main Iceberg window
8. Open the contextual menu and select
  *Metacello -> Install baseline of Willow-Auth0 ...*
